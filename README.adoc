...
I say "struggled in the past" because many of the APM vendors are now starting to embrace and support open source projects like 
https://opentelemetry.io/docs/reference/specification/overview/[OpenTelemetry] and standards such as 
https://www.w3.org/TR/trace-context/[W3C Trace Context] to help them fill in the "holes".
