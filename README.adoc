...
image::API-Led-1.png[title="API Led to Help Solve for Composability",1000, 1000, align="center"]
...
image::Macro-Micro-Metrics.png[title="Micro-level and Macro-level Metrics", 1000, 1000, align="center"]
...
image::Mule-4-OTel-Agent-Flowchart.png[850, 850, title="Mule Agent Flowchart - Notification Processing", align="center"]
...
IMPORTANT: Only Mule applications which add the agent to their configuration will generate and export trace data.

image::agent-connector-config.png[700, 700, title="Mule Agent Configuration", align="center"]
...
<4> Add any necessary vendor-specific headers
<5> Provide a service name - usually the application name
...
<1> *key*: `traceparent`  *value*:  `#[vars.OTEL_TRACE_CONTEXT.traceparent default '' as String]`
<2> *key*: `tracestate`   *value*:  `#[vars.OTEL_TRACE_CONTEXT.tracestate  default '' as String]`

image::http-requester-config.png[500, 500, title="Mule HTTP Requester Configuration", align="center"]
...
==== Demo Distributed Mule Applications Diagram

image::Distributed-Mule-App-Diagram.png[1400, 1400, title="Demo Mule Application Diagram", align="center"]
