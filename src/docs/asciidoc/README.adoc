...
====
image::agent-connector-config-metrics.png[1000, 1000, title="Mule Agent Configuration - Metrics", align="center"]
====
...
image::agent-connector-config-traces.png[1000, 1000, title="Mule Agent Configuration - Traces", align="center"]
====
