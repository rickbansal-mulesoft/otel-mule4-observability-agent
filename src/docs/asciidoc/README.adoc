...
This new Mule custom module of Open Telemetry also supports the OLTP endpoint with a self-signed certificate by adding Truststore into the configuration. Below are the steps for configuring it:
...
<2> Truststore file location that will load to Mule Application Classpath.
