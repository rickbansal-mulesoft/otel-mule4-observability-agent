...
which has an HTTP Listener as its source trigger.
...
<3> The Resource Attributes are specified in the configuration of the Agent
...
Database Processor specific attributes.
