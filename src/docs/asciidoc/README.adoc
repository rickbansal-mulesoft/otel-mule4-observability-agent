...
:revnumber: 1.0.95-SNAPSHOT
:revdate: February 25, 2022
...
https://github.com/rickbansal-mulesoft/otel-mule4-observability-agent/blob/main/target/otel-mule4-observability-agent-1.0.92-SNAPSHOT-mule-plugin.jar[here]

==== Add the Extension to Your Maven Repository

You can add the extension to your local Maven repo in one of two ways:

* Manually from the command line - assuming you have Maven installed
* Through Anypoint Studio

===== Add via Maven Command Line

===== Add via Anypoint Studio
