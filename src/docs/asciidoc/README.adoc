...
As shown below in the graphic, a 2021 GigaOm study concluded that big-name cloud players are moving to embrace OpenTelemetry quickly 
and observability vendors are likewise offering integration with OpenTelemetry tools.  The GigaOm study also reveals full adoption 
