...
The Gartner definition of DEM, while comprehensive, is but a bit of mouthful.  A simpler definition is:

====
[quote, Simple]
DEM allows an enterprise to provide the best experience possible to both internal and external customers.
====
 
.Technical Concern 
In order to better support the business aspirations of DEM, I believe these two *technical* capabilities are necessary prerequisites:
