...
| Send Custom Attributes for Flow Spans a| Boolean |  +++Generate and send custom attributes when a flow starts+++ |  +++false+++ | {nbsp}
| Send Custom Attributes for Message Proccesor Spans a| Boolean |  +++Generate and send custom attributes when a message proccesor starts+++ |  +++false+++ | {nbsp}
| User Defined Custom Attributes a| Array of <<attribute>> |  +++List of user defined custom attributes in name-value pairs.+++ |  | {nbsp}
|======================
